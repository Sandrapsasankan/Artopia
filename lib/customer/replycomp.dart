...
class replycomp extends StatefulWidget {
  final int id;
  const replycomp({required this.id});

  @override
  State<replycomp> createState() => _replycompState();
}

class _replycompState extends State<replycomp> {
  ...
  Future<void> _viewPro() async {
    ...
    var res = await Api().getData('/api/complaint_reply/' + user_id.toString() + '/' + id.toString());
  ...
  _fetchData() async {
    ...
    var res = await Api()
        .getData('/api/complaint_reply/' + userid.toString() + '/' + id.toString ());
