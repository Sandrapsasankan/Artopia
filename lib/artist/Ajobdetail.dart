...
class Ajobapply extends StatefulWidget {
  final int id;

  Ajobapply({required this.id});

  @override
  State<Ajobapply> createState() => _AjobapplyState();
}

class _AjobapplyState extends State<Ajobapply> {
